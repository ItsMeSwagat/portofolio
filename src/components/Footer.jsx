      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          data-aos-duration="1500">
            <a href="#home" class="flex items-center">
              <span class="self-center text-4xl font-semibold whitespace-nowrap dark:text-white">
                PORTO<span className=" text-yellow-400">FOLIO</span>
              </span>
            </a>
          </div>
          <div
          ...
          >
            ...
            <div>
              ...
              <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
                  <a
                    href="https://github.com/ItsMeSwagat"
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/swagatshrestha/"
                    class="hover:underline"
                  >
                    LinkedIn
                  </a>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            <a
              href="https://www.facebook.com/niku.piku99/"
