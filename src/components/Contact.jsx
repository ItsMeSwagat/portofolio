  ...
  return (
    <section id="Contact" className="bg-white">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h2 className="mb-4 text-4xl md:text-7xl tracking-tight font-extrabold text-center">
          Contact <span className=" text-yellow-400">Me</span>
        </h2>
        <p className="mb-8 lg:mb-16 text-center text-black font-medium sm:text-xl">
          Please feel free to Contact me anytime. Thank You
        </p>
        <form  action="https://formspree.io/f/mgejavkd" method="POST" className="space-y-8">
          <div>
