    ...
    <section id='Contact' className="bg-white">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form action="#" className="space-y-8">
              <div>
                  <label for="email" className="block mb-2 text-lg font-semibold">Your <span className=' text-yellow-400'>Email</span></label>
              ...
              <div>
                  <label for="subject" className="block mb-2 text-lg font-semibold">Sub<span className=' text-yellow-400'>ject</span></label>
              ...
              <div className="sm:col-span-2">
                  <label for="message" className="block mb-2 text-lg font-semibold">Your <span className=' text-yellow-400'>Message</span></label>
